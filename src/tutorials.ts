...
- **CORS handling**: Subscription login token exchanges use local extension rules. If you enable a custom CORS proxy in settings, requests that need it can be routed through that proxy
